 ...
 */
export function SettingCard({ title, description, children, variant = 'default', className }: SettingCardProps) {
  return (
    <div
      className={classNames(
        'rounded-[calc(var(--radius))] border p-6 transition-theme animate-scaleIn',
        variant === 'danger'
