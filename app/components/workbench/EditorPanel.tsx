                  ...
                  {isDragging && (
                    <div className="drop-overlay absolute inset-0 z-10 flex items-center justify-center bg-bolt-elements-background-depth-2/80 border-2 border-dashed border-bolt-elements-borderColor text-bolt-elements-textSecondary">
                      <div className="text-center">
                        ...
                        <div className="text-xs mt-1">We'll scan files and show a preview</div>
                      </div>
                    </div>
                  )}
                                    ...
                                    {importPreviewState.preview.topLevelFolders.map((f) => {
                                      ...
                                      return (
                                        ...
                                        >
                                          {f}
                                          {stat ? (
                                            <span className="ml-1 opacity-70">{`(${(stat.bytes / 1024 / 1024).toFixed(
                                              1,
                                            )} MB)`}</span>
                                          ) : null}
                                        </button>
            ...
            <div className="h-full">
              <div className="bg-bolt-elements-terminals-background h-full flex flex-col">
                <div className="flex items-center bg-bolt-elements-background-depth-2 border-y border-bolt-elements-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {/* Controls */}
                  <div className="ml-auto flex items-center gap-1.5 rounded-md border border-bolt-elements-borderColor bg-bolt-elements-background-depth-2/90 px-1 py-1 transition-theme">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        {['npm run dev', 'pnpm dev', 'yarn dev', 'vite'].map((command) => (
                          <DropdownMenuItem key={command} onSelect={() => workbenchStore.setRestartCommand(command)}>
                            {workbenchStore.getRestartCommand() === command && <Check className="w-4 h-4 mr-2" />}
                            {command}
                          </DropdownMenuItem>
                        ))}
                      </DropdownMenuContent>
                    ...
                    <div className="h-4 w-px bg-bolt-elements-borderColor mx-1.5" />
                    ...
                    <div className="flex items-center">
                      ...
                      >
                        <span className="text-sm font-medium text-bolt-elements-textSecondary">Clear</span>
                      </PanelHeaderButton>

                      <PanelHeaderButton onClick={() => restartDevServer()}>
                        <RefreshCcw className="w-4 h-4" />
                        <span className="text-sm font-medium text-bolt-elements-textSecondary">Restart Dev</span>
                      </PanelHeaderButton>

                      <PanelHeaderButton onClick={() => killDevServer()}>
                        <Power className="w-4 h-4" />
                        <span className="text-sm font-medium text-bolt-elements-textSecondary">Stop Dev</span>
                      </PanelHeaderButton>
                    </div>
