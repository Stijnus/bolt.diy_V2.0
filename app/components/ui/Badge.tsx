  ...
  'inline-flex items-center gap-1.5 rounded-full border px-3 py-1 text-xs font-semibold transition-all focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        success: 'border-transparent bg-bolt-elements-background-depth-3 text-bolt-elements-icon-success',
        warning: 'border-transparent bg-bolt-elements-item-backgroundAccent text-bolt-elements-item-contentAccent',
